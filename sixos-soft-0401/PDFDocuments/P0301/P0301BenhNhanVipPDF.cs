...
using VipPatientReport.Models.M0301.M0301BenhNhanVip;

namespace VipPatientReport.PDFDocuments.P0301
{
    public class P0401_DSNguoiBenhThucHienCLS : IDocument
    {
        private readonly List<M0301BenhNhanVipModel> _data;
        ...
        public P0401_DSNguoiBenhThucHienCLS(List<M0301BenhNhanVipModel> data, string fromDate, string toDate, M0301ThongTinDoanhNghiep doanhNghiep)
        {
            _data = data ?? new List<M0301BenhNhanVipModel>();
